...
const AILoader: React.FC<AILoaderProps> = ({ size = 180, text = "Gerando" }) => {
  const letters = text.split("");

  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-b from-[hsl(var(--primary))] via-[hsl(var(--background))] to-black/90">
      <div
